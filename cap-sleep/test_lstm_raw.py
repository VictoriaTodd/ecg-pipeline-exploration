from cap_sleep_dataset_raw import CapSleepDatasetRaw
...
# Open a new file
file1 = open("cap_sleep_run_lstm_raw.txt", "a")

from toy_lstm import ToyLSTM
...
train_dataset = CapSleepDatasetRaw(train_files)
test_dataset = CapSleepDatasetRaw(test_files)
